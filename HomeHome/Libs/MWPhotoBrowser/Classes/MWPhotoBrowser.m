...
- (void)setCommentItemWith:(NSString *)item andTarget:(id)target andAction:(SEL)selector
{
    UIBarButtonItem *bar = [[UIBarButtonItem alloc]initWithTitle:item style:UIBarButtonItemStyleDone target:target action:selector];
    self.navigationItem.rightBarButtonItem = bar;
}

//- (void)setToolbarItemWith:(id)target andIscoll:(BOOL)iscoll;
//{
//    NewsDetailToolBar *toolBar = [[NewsDetailToolBar alloc]initFourWithFrame:CGRectMake(0, kScreenH - 44, kScreenW, 44)];
//    toolBar.isCollection = iscoll;
//    [self.view addSubview:toolBar];
//    self.toolBar = toolBar;
//    toolBar.v_delegate = target;
//    toolBar.showFontChange = NO;
//}
//
//- (void)initFadeViewWith:(id)target
//{
//  //  if (!self.fadeView)
//    //{
//        self.fadeView = [[RGFadeView alloc]initWithFrame:CGRectMake(0, 0 ,kScreenW,kScreenH)];
//        self.fadeView.v_delegate = target;
//        [self.view.window addSubview:self.fadeView];
//    //}
//    [self.fadeView.msgTextView becomeFirstResponder];
//  //  [self.view.window bringSubviewToFront:self.fadeView];
//}
