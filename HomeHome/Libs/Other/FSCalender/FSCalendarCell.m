...
- (void)setBounds:(CGRect)bounds
{
    ...
    CGFloat eventSize = _backgroundLayer.frame.size.height/1.0;
  //  _eventLayer.frame = CGRectMake((_backgroundLayer.frame.size.width-eventSize)/2+_backgroundLayer.frame.origin.x, CGRectGetMaxY(_backgroundLayer.frame)+eventSize*0.2, eventSize*0.8, eventSize*0.8)
    ...
    _eventLayer.cornerRadius = eventSize/2;
    _eventLayer.frame = _backgroundLayer.frame;
    _eventLayer.opacity = 0.25;
//     _eventLayer.frame = CGRectMake((_backgroundLayer.frame.size.width-eventSize)/2+_backgroundLayer.frame.origin.x, CGRectGetMaxY(_backgroundLayer.frame)+eventSize*0.2, eventSize*0.8, eventSize*0.8);
...
//        
//        UIImageView *back = [[UIImageView alloc]initWithFrame:CGRectMake((self.fs_width - titleHeight)/2 - 10, 0, self.contentView.fs_width/2, self.contentView.fs_width/2)];
//        back.alpha = 0.5;
//        back.backgroundColor = [UIColor redColor];
//        back.layer.masksToBounds = YES;
//        back.layer.cornerRadius = self.contentView.fs_width/4;
//        [self.contentView addSubview:back];
        _imageLayer.frame = CGRectMake((self.fs_width-_image.size.width), self.fs_height-_image.size.height, _image.size.width, _image.size.height);
