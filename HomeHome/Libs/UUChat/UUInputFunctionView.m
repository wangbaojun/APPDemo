...
- (id)initWithSuperVC:(UIViewController *)superVC
{
    ...
    if (self) {
        ...
        [self.btnVoiceRecord setTitle:@"松手 发送语音" forState:UIControlStateHighlighted];
...
{
    [UUProgressHUD changeSubTitle:@"上滑 取消发送"];
}
...
- (void)voiceRecord:(UIButton *)sender
{
    ...
    if (isbeginVoiceRecord) {
        ...
        self.frame = CGRectMake(0, Main_Screen_Height-64-40, Main_Screen_Width, 40);
        [self.TextViewInput resignFirstResponder];
    }else{
        [self.btnChangeVoiceState setBackgroundImage:[UIImage imageNamed:@"chat_voice_record"] forState:UIControlStateNormal];
         self.frame = CGRectMake(0, Main_Screen_Height-64-200, Main_Screen_Width, 200);
